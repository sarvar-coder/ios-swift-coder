...
//        backgroundColor = .systemOrange
    ...
    func layout() {
        ...
        // error label
        NSLayoutConstraint.activate([
            errorLabel.topAnchor.constraint(equalToSystemSpacingBelow: dividerView.bottomAnchor, multiplier: 1/2),
...
extension PasswordTextField {
    ...
    @objc func textFieldEditingChanged(_ sender: UITextField) {        delegate?.editingChanged(self)
    }
}
